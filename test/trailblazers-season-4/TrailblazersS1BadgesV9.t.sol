...
contract TrailblazersS1BadgesV9 is Test {
    ...
    function test_setSeasonEndTimestamp() public {
        test_upgrade();
        vm.warp(0);
        vm.startPrank(owner);
        // s1
    ...
    function test_getCurrentSeasonId() public {
        test_upgrade();
        test_setSeasonEndTimestamp();
        vm.warp(SEASON_1_END - 1);
        assertEq(s1BadgesV9.getCurrentSeasonId(), 1);
        vm.warp(SEASON_1_END + 1);
        assertEq(s1BadgesV9.getCurrentSeasonId(), 2);
    }
    ...
    function test_getCurrentSeasonEndTimestamp() public {
        ...
        test_setSeasonEndTimestamp();
        vm.warp(SEASON_1_END - 1);
        assertEq(s1BadgesV9.getCurrentSeasonEndTimestamp(), SEASON_1_END);
        vm.warp(SEASON_1_END + 1);
        assertEq(s1BadgesV9.getCurrentSeasonEndTimestamp(), SEASON_2_END);
    }
