...
import "../../../contracts/eventRegister/PreconfsEventRegister.sol";

contract PreconfsEventRegisterTest is Test {
    PreconfsEventRegister public eventRegister;
    ...
    function testMultipleUsersRegistration() public {
        ...
        assertEq(eventRegister.isRegistered(0, user1), 1);
        assertEq(eventRegister.isRegistered(0, user2), 1);
    }
