...
contract UpgradeS1BadgesV10 is Script {
    ...
    TrailblazersBadgesV10 public token;
    ...
    function run() public {
        ...
        TrailblazersBadgesV9 tokenV9 = TrailblazersBadgesV9(s1TokenAddress);

        tokenV9.upgradeToAndCall(
            address(new TrailblazersBadgesV10()), abi.encodeCall(TrailblazersBadgesV10.version, ())
        );

        token = TrailblazersBadgesV10(address(tokenV9));

        console.log("Upgraded TrailblazersBadgesV10 on:", address(token));
    }
}
